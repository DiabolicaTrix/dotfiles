...
async function doActivate(context, createLc) {
    ...
    apiClient = createLc('volar-api', 'Volar - API', languageFeaturesDocumentSelector, getInitializationOptions(context, 'api', undefined, lowPowerMode), 6009);
    docClient = !lowPowerMode ? createLc('volar-document', 'Volar - Document', languageFeaturesDocumentSelector, getInitializationOptions(context, 'doc', undefined, lowPowerMode), 6010) : undefined;
    htmlClient = createLc('volar-html', 'Volar - HTML', documentFeaturesDocumentSelector, getInitializationOptions(context, 'html', undefined, lowPowerMode), 6011);
