...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/k_/8vlcmm3x665gvkzv40vtmm2r0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/amantha/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/amantha/.mailcheckrc"
# }
